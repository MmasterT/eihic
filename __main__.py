...
def main():
    ...
    parser_configure.add_argument(
        "--reference",
        help=f"Provide the absolute path to a reference fasta file to map the Hi-C reads",
    )
    parser_configure.add_argument(
        "--organism",
        help=f"Organism name used for naiming only. This do not change anything but the files naming.",
    )
    parser_configure.add_argument(
        "--jira",
